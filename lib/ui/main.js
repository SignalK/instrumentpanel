...
class App extends React.Component {
  ...
  onGridLayoutChange(layout, layouts) {
    debug("[onGridLayoutChange] new/old layout[" + Object.keys(layouts)[0] + "]:", layout, this.state.gridSettings.layout);
      ...
      <div>
        ...
        {doRenderReactGridLayout ?
          <ReactGridLayout
            ...
            //layouts={this.state.gridSettings.layout}
  ...
  wrapWidget(widget) {
    ...
    //debug("[wrapWidget] data-grid: ", widgetLayout);
