...
const HelpComponent = React.lazy(() => import('../util/help'));
import {getUrlParameter, reloadWithParams} from '../util/browser';
//import {ResetComponent} from './settings/resetsettings';
const ResetSettings = React.lazy(() => import('./settings/resetsettings'));
...
// https://github.com/STRML/react-grid-layout/issues/382#issuecomment-299734450
    ...
    return (
      <div>
        ...
        {this.state.helpVisible ? <Suspense fallback={<img src="./img/snooker.gif"/>}><HelpComponent /></Suspense> : null}
...
//  var resetSettings = ReactDOM.render(<ResetComponent/>, document.getElementById('content'));
  var resetSettings = ReactDOM.render(
    <Suspense fallback={<img src="./img/snooker.gif"/>}>
      <ResetSettings/>
    </Suspense>
