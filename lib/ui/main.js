...
class App extends React.Component {
  constructor(props) {
    ...
    console.log('css-prefers-color-scheme hasNativeSupport:', instrumentPanel.colorSchemeTool.hasNativeSupport);
    console.log('colorScheme:', instrumentPanel.colorSchemeTool.scheme);
    ...
    instrumentPanel.colorSchemeTool.onChange = () => {
      console.log('new colorScheme:', instrumentPanel.colorSchemeTool.scheme);
    };
