...
import {
  ...
  CS_BY_OS,
  CS_BY_SKPATH
} from './settings/colorschemesettings';
...
InstrumentPanel.prototype.getDarkMode = function getDarkMode() {
  return (this.colorScheme.colorSchemeCurrent === CS_DARK);
}

InstrumentPanel.prototype.setDarkMode = function setDarkMode(darkModeOn) {
  this.colorSchemeTool.scheme = (darkModeOn) ? CS_DARK : CS_LIGHT;
  this.colorScheme.colorSchemeCurrent = this.colorSchemeTool.scheme;
}

InstrumentPanel.prototype.getColorSchemeCurrent = function getColorSchemeCurrent() {
  return this.colorScheme.colorSchemeCurrent;
}

InstrumentPanel.prototype.setColorSchemeSetBy = function setColorSchemeSetBy(newColorSchemeSetBy) {
  this.colorScheme.colorSchemeSetBy = newColorSchemeSetBy;
}

InstrumentPanel.prototype.setColorSchemeSetByMAINBAR = function setColorSchemeSetByMAINBAR() {
  this.colorScheme.colorSchemeSetBy = CS_BY_MAINBAR;
}

InstrumentPanel.prototype.isColorSchemeByOS = function isColorSchemeByOS() {
  return (this.colorScheme.colorSchemeSetBy === CS_BY_OS);
}

InstrumentPanel.prototype.isColorSchemeSetBySKPATH = function isColorSchemeSetBySKPATH() {
