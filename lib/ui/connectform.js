  ...
  render: function() {
    ...
    return (
      <div class="form-group">
          <ConnectionIndicator allUpdates={this.props.allUpdates} style={{position:"absolute"}}/>
  ...
  doConnectOrDisconnect: function(host) {
    if (!this.state.connecting && !this.state.connected) {
      this.setState({
        "connecting": true,
        "host": host,
        "connection":signalk.connectDelta(host, this.props.dispatch, this.onConnect, this.onDisconnect),
