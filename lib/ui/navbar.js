...
import {setKeyStartConnected, getKeyStartConnected} from '../util/localstorage';
...
export default class IpNavBar extends React.Component {
  ...
  componentDidMount() {
    if (getKeyStartConnected()) this.connectOrDisconnect();
  }
