...
export default class SettingsPanel extends React.Component {
  ...
  getContentBySettingsKey() {
    if (this.state.activeKey === 'ST_DisplayValue') {
      ...
      return (<SaveLoadSettingsUnits instrumentPanel={this.props.instrumentPanel} displayKey={saveDisplayKey} />);
    } else if (this.state.activeKey === 'ST_Load') {
      return (<SaveLoadSettingsUnits instrumentPanel={this.props.instrumentPanel} displayKey={loadDisplayKey} />);
    }
    return null;
  }
