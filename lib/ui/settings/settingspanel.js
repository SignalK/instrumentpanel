...
import {Panel, Alert, SplitButton, MenuItem} from 'react-bootstrap';
...
const PreferredUnits = React.lazy(() => import('./preferredunits'));
const ResetSettings = React.lazy(() => import('./resetsettings'));
const ColorSchemeSettings = React.lazy(() => import('./colorschemesettings'));
const SaveLoadSettingsUnits = React.lazy(() => import('./saveload'));
import {
  saveDisplayKey,
  loadDisplayKey
} from './constants';
    ...
    return (
      <React.Fragment>
        ...
        <Panel>
          ...
          <Panel.Body>
            <Suspense fallback={<img src="./img/snooker.gif"/>}>
