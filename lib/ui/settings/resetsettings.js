...
import { Form, HelpBlock, Button } from 'react-bootstrap';
  ...
  render() {
    ...
    var cancelButton = function () {
      return (typeof that.props.instrumentPanel === 'undefined') ?
        (<Button key="cancel" variant="ip" onClick={that.doCancel}>Cancel</Button>) : null;
    }
    ...
    return (
      <div className="resetSettings">
        ...
        {checkboxItems}
        <Button key="reset" variant="danger" disabled={this.state.submitDisable} onClick={this.doReset}>Reset</Button>&nbsp;
        {cancelButton()}
      </div>
    );
  }
