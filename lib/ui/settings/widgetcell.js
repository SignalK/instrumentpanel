...
export default class WidgetCell extends React.Component {
  ...
  checkBoxActiveDelete() {
    return (
      <React.Fragment>
        <Form.Check className='headerCbShow' checked={this.props.widget.options.active} disabled={this.props.widget.options.delete} onChange={this.toggleActive} label="Show on grid&nbsp;" />
        <Form.Check className='headerCbShow' checked={this.props.widget.options.delete} disabled={this.props.widget.options.active} onChange={this.toggleDelete} label="Delete" />
      </React.Fragment>
    )
  }
    ...
    return (
      <div className={this.getBorderClass()}>
        <div className='header'>
          ...
          <Button className='headerEdit' size="sm" onClick={() => this.props.changeWidgetInEdit('')}>Done</Button>
        </div>
  ...
  //    <Button className='headerEdit' size="sm" onClick={() => this.props.changeWidgetInEdit(this.props.widget.id)}>Edit</Button>
