    ...
    render: function() {
      ...
      return (
        <svg key={id} onClick={this.changeFormatPosition} height="100%" width="100%" viewBox="0 0 20 40">
          <text x="10" y="19" textAnchor="middle" fontSize="16" dominantBaseline="middle">{objectPosition.latitude}</text>
          <text x="10" y="35" textAnchor="middle" fontSize="16" dominantBaseline="middle">{objectPosition.longitude}</text>
