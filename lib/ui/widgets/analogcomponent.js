...
import {getShadow, getHand} from './gaugecomponents';
  ...
  render: function() {
    ...
    return (
      <svg height="100%" width="100%" viewBox="0 -20 400 240">
        ...
        <g transform={'translate(' + half + ',' + half + ' )'} stroke={textColor}>
          ...
          <path d={arc()} strokeWidth="5" fill={textColor} />

          <path d={redArc()} strokeWidth="5" fill="red" />
          ...
          <text  y="-50" textAnchor="middle" fontSize="70" dominantBaseline="middle" fill={textColor}>
