...
export default class AnalogComponent extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      zone1: this.props.options.zone1,
      zone2: this.props.options.zone2,
      zone3: this.props.options.zone3,
      zone4: this.props.options.zone4,
  ...
  renderColorArc(zone, radianScale) {
    try {
      ...
      return (<path d={arc()} strokeWidth="2" fill={zone.color} />)
    } catch (ex) {
      console.log(ex)
    }
    return null
    ...
    try {
      ...
      return (
        <svg height="100%" width="100%" viewBox="0 -20 400 240">
          ...
          {this.renderColorArc(this.state.zone1, radianScale)}
          {this.renderColorArc(this.state.zone2, radianScale)}
          {this.renderColorArc(this.state.zone3, radianScale)}
          {this.renderColorArc(this.state.zone4, radianScale)}
