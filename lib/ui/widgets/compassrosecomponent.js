  ...
  render() {
    ...
    return (
      ...
      <g transform="scale(0.8) translate(50 50)">
        ...
        <text x="200" y="24" textAnchor="middle" fontSize="20">{this.props.options.label}</text>
        <text x="200" y="325" textAnchor="middle" fontSize="28">{angleText}</text>
        <text x="200" y="390" textAnchor="middle" fontSize="20">{(angleText !== 'NaN') ? this.renderDirName(angle) : angleText}</text>
