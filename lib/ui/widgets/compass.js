...
/*
  var elementRoseComponent = React.createElement('div',null,id);
  var elementReadingComponent = React.createElement('div',null,id);
  var elementDigitalComponent = React.createElement('div',null,id);
  this.widgets = [elementRoseComponent, this.reading = elementReadingComponent, elementDigitalComponent];
*/
