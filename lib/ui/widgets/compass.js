...
var componentClass = React.createClass({
  ...
  renderTicks: function() {
    ...
    for (var i = 0; i < 180; i += 5) {
      ...
      if(i % 45 != 0) {
        ticks.push(
          <path d={["M", half, "0 L", half, tick, "M", half, size - tick, "L",
            half, size].join(" ")} strokeWidth="1" transform={centerRotate(i)}
          />
        );
      }
    }
    ...
    return (
      <g>
        <g transform="scale(1.25) translate(-40 -40)">
          <g id="layer1" fill="none" stroke-width="1" stroke="black">
          ...
          <g id="layer2" fill="none" stroke-width="1" stroke="black" transform="rotate(45 200 200) translate(50 50) scale(0.75)">
          ...
          <g id="layer3" fill="none" stroke-width="1" stroke="black" transform="rotate(25 200 200) translate(100 100) scale(0.5)">
            <path d="M 190,190 200,110 210,190" />
            <path d="M 190,190 110,200 190,210" />
            <path d="M 210,190 290,200 210,210" />
            <path d="M 190,210 200,290 210,210" />
          ...
          <g id="layer4" fill="none" stroke-width="1" stroke="black" transform="rotate(-25 200 200) translate(100 100) scale(0.5)">
            <path d="M 190,190 200,110 210,190" />
            <path d="M 190,190 110,200 190,210" />
            <path d="M 210,190 290,200 210,210" />
            <path d="M 190,210 200,290 210,210" />
          ...
          <circle cx="200" cy="200" r="25" fill="white" stroke="black" stroke-width="1" />
          <circle cx="200" cy="200" r="20" fill="white" stroke="black" stroke-width="1" />
        </g>
  ...
  renderRoseStyle2: function() {
    return (
      <g id="layer1" fill="none" stroke-width="0" stroke="none" transform="translate(200,200) scale(1.25)">
  ...
  render: function() {
    return (
      <svg height="100%" width="100%" viewBox="0 0 400 400">
        ...
        <text x="200" y="325" textAnchor="middle" fontSize="28">{this.state.value.toFixed(2)}</text>
        <text x="200" y="390" textAnchor="middle" fontSize="20">{this.renderDirName()}</text>
        <polygon points="200,60 195,90 205,90 Z" fill="url(#g1)" />
        <polygon points="200,60 195,80 205,80 Z" fill="url(#g1)" transform="rotate(45 200 200)" />
        <polygon points="200,60 195,80 205,80 Z" fill="url(#g1)" transform="rotate(315 200 200)" />
      </svg>
    )
  },
