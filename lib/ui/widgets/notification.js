...
function Notification(id, options, streamBundle, instrumentPanel) {
  ...
  this.valueStream.onValue(notification => {
    var levelChange = false;
    var oldLevel;
    if (notification.value === null || typeof notification.value !== 'object'){
      notification.value = defaultValue;
    }
    oldLevel = this.notification.value.level || 0;
    this.notification.value = notification.value;
    ...
    this.valueBus.push(notification.value);
  })
/*
