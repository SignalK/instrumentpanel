  ...
  render() {
    return (
        <svg height="100%" width="100%" viewBox="100 0 200 100">
          ...
          <text x="200" y="90" textAnchor="middle" fontSize="12" dominantBaseline="middle">{this.props.label}</text>
          <text x="200" y="120" textAnchor="middle" fontSize="6" dominantBaseline="middle">{this.props.sourceId}</text>
        </svg>
    )
  }
