      ...
      try {
        return (
          <svg key={id} height="100%" width="100%" viewBox="0 0 20 30" stroke="none">
            {this.dynamicPositions.labelVisible && <text x="10" y="3" textAnchor="middle" fontSize="4" dominantBaseline="middle" textDecoration={this.dynamicPositions.labelTextDecoration}>{this.widgetLabel}</text>}
