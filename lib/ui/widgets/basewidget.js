...
//    this.optionsBundle.busNewOptions.push([options, metaWithValue.value])
  })
  ...
  this.optionsBundle.isValidStream = this.streamBundle.getStatusTimeoutStreamForSourcePath(this.options.sourceId, this.options.path);
}
