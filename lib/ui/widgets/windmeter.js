  ...
  render: function() {
    ...
    return (
      <svg height="100%" width="100%" viewBox="0 0 400 400">
        ...
        <g fill={textColor} stroke={textColor} transform="scale(0.9) translate(20 40)">
          ...
          <text x="200" y="174" textAnchor="middle" fontSize="38" dominantBaseline="bottom">
            {getDisplayWindAngle(this.state.angle)}
          </text>
          <rect width="150" height="50" x="125" y="215" rx="5" ry="5" fill="rgba(255,255,255,0.8)" />
          <text x="200" y="252" textAnchor="middle" fontSize="38" dominantBaseline="bottom">
        ...
        <text x="200" y="24" textAnchor="middle" fontSize="28.2" fill={textColor}>{this.state.label}</text>
      </svg>
    )
  },
...
function getDisplayWindAngle(value) {
  return value >= 0 && value <= 180 ? value:
         value > 180 ? Math.abs(value - 360).toFixed(2) :
...
WindMeter.prototype.getHandledSources = function() {
  return _.values(this.options.activeSources);
}
