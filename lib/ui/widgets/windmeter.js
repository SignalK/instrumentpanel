    ...
    return (
      <svg height="100%" width="100%" viewBox="0  0 400 400">
        ...
        <g stroke="black">
          ...
          <g stroke="black">
            <rect width="140" height="50" x="130" y="135" rx="5" ry="5" style={{"fill":"white", "opacity":"0.8"}}></rect>
            <text x="200" y="172" textAnchor="middle" fontSize="38" dominantBaseline="middle">{getDisplayWindAngle(this.state.angle)}</text>
          </g>
          <g>
            <rect width="200" height="50" x="100" y="215" rx="5" ry="5" style={{"fill":"white", "opacity":"0.8"}}></rect>
            <text x="200" y="252" textAnchor="middle" fontSize="38" dominantBaseline="middle">{safeFixed(this.state.speed)}</text>
          </g>
