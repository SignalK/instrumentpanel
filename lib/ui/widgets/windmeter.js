...
var subscribes = {
  'environment.wind.angleApparent': function(sourceId, stream) {
    if (!this.state.activeStreams['environment.wind.angleApparent']) {
      var that = this;
      this.state.activeStreams['environment.wind.angleApparent'] = stream.onValue(function(value) {
        that.setState({
  ...
  'environment.wind.speedApparent': function(sourceId, stream) {
    ...
    if (!this.state.activeStreams['environment.wind.speedApparent']) {
      this.state.activeStreams['environment.wind.speedApparent'] = stream.onValue(function(value) {
        that.setState({
          speed: value
        })
      })
