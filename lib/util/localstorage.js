/* window.localStorage layout new design
...
Value= {
  hostName: { // Host where connected
    layoutName: { // value of URL parameter ?layout=myLayout | referrer pathName | default
      pages: [ // original content from signalkGrid3.hostName
        {
...
export function getKeyStartConnected() {
  try {
...
export function setKeyStartConnected(value) {
  window.localStorage[startConnectedKeyName] = value;
}

export function getKeyPreferredUnits() {
  try {
...
export function setKeyPreferredUnits(preferredUnits) {
  try {
